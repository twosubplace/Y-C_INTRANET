...
-- Database Schema for Oracle Database (Simple version without constraints)
...
-- Table: members (only if not exists, no constraints)
DECLARE
  v_count NUMBER;
BEGIN
...
-- Table: events (only if not exists, no foreign keys or check constraints)
DECLARE
  v_count NUMBER;
BEGIN
...
-- Table: approvals (only if not exists, no foreign keys or check constraints)
-- NOTE: Changed 'comment' to 'approval_comment' because 'comment' is a reserved word in Oracle
DECLARE
  v_count NUMBER;
BEGIN
...
BEGIN
  ...
  IF v_count = 0 THEN
    ...
    INSERT INTO approvals (event_id, step_order, approver_id, decision, approval_comment, submitted_at, decided_at) VALUES
    (1, 1, 3, 'APPROVED', '승인합니다', TO_TIMESTAMP('2025-12-20 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2025-12-20 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO approvals (event_id, step_order, approver_id, decision, approval_comment, submitted_at, decided_at) VALUES
    (2, 1, 1, NULL, NULL, TO_TIMESTAMP('2025-12-23 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), NULL);
    INSERT INTO approvals (event_id, step_order, approver_id, decision, approval_comment, submitted_at, decided_at) VALUES
    (3, 1, 1, 'APPROVED', '승인', TO_TIMESTAMP('2025-12-22 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2025-12-22 15:00:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO approvals (event_id, step_order, approver_id, decision, approval_comment, submitted_at, decided_at) VALUES
    (4, 1, 1, 'APPROVED', '승인', TO_TIMESTAMP('2025-12-19 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2025-12-19 11:00:00', 'YYYY-MM-DD HH24:MI:SS'));
